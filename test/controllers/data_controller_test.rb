...
class DataControllerTest < ActionController::TestCase
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post :create, datum: { address_id: @datum.address_id, category: @datum.category, data: @datum.data }
    end
  ...
  test "should update datum" do
    patch :update, id: @datum, datum: { address_id: @datum.address_id, category: @datum.category, data: @datum.data }
    assert_redirected_to datum_path(assigns(:datum))
  end
